...
Step 2 => Execute index.php file according to your file path.

Example payload with which I tested:

{
  ...
  "ext": {
    "google_query_id": "AA8e6VI-G-6-\nPHEjFD9KLYFQqH6v_SGtU6wcSv_E4yC7YgDuY37SAecQnCz_PggyO4x3-KIFQA",
    "fcap_scope": 3,
    "privacy_treatments": {
